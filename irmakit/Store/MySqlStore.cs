...
{
	public sealed class MySqlStore : IDBStore
	{
		...
		*/
		...
		public MySqlStore(string host, int port, string user, string password, string db, string charset, bool pooling, int maxPoolSize, int connectionLifetime, bool allowUserVariables=true)
		{
			StringBuilder sb = new StringBuilder();
			sb.Append("Server=").Append(host)
		...
		public MySqlStore(string host, int port, string user, string password, string db, string charset, bool pooling, int maxPoolSize, bool allowUserVariables=true)
		: this(host, port, user, password, db, charset, pooling, maxPoolSize, 300, allowUserVariables)
		{
		}

		public MySqlStore(string host, int port, string user, string password, string db, string charset, bool pooling, bool allowUserVariables=true)
		: this(host, port, user, password, db, charset, pooling, 100, 300, allowUserVariables)
		{
		}

		public MySqlStore(string host, int port, string user, string password, string db, string charset, bool allowUserVariables=true)
		: this(host, port, user, password, db, charset, true, 100, 300, allowUserVariables)
		{
		}

		public MySqlStore(string host, int port, string user, string password, string db, bool allowUserVariables=true)
		: this(host, port, user, password, db, null, true, 100, 300, allowUserVariables)
		{
		}
			...
			try {
				...
				if (parameters != null) {
					foreach (KeyValuePair<string, object> p in parameters)
						((MySqlParameterCollection)cmd.Parameters).AddWithValue(p.Key, p.Value);
				}
		...
		public DbDataReader Query(string sql, int timeout, params MySqlParameter[] parameters)
		{
		...
		public DbDataReader Query(string sql, params MySqlParameter[] parameters)
		{
			return Query(sql, 0, (DbParameter[])parameters);
		}
		...
		public object QuerySingle(string sql, int timeout, params MySqlParameter[] parameters)
		{
		...
		public object QuerySingle(string sql, params MySqlParameter[] parameters)
		{
			return QuerySingle(sql, 0, (DbParameter[])parameters);
		}
		...
		public DataSet QueryDataSet(string sql, int timeout, params MySqlParameter[] parameters)
		{
		...
		public DataSet QueryDataSet(string sql, params MySqlParameter[] parameters)
		{
			return QueryDataSet(sql, 0, (DbParameter[])parameters);
		}
		...
		public int Execute(string sql, int timeout, params MySqlParameter[] parameters)
		{
		...
		public bool BulkInsert(string tableName, DataTable dt, int timeout)
		{
			...
			try {
				...
				MySqlCommandBuilder cb = new MySqlCommandBuilder(dap);
			...
			try {
				...
				if (outParams != null) {
					foreach (KeyValuePair<string, object> p in outParams) {
						MySqlParameter mp = ((MySqlParameterCollection)cmd.Parameters).AddWithValue(p.Key, p.Value);
		...
		public bool Procedure(string proc, params MySqlParameter[] parameters)
		{
